...
from techconnect_classes.core.config import get_setting
from techconnect_classes.database import (
    get_engine,
    get_managed_db,
    get_sqlalchemy_db_url,
)
from techconnect_classes.database.db import ModelType
from techconnect_classes.models import (
    AdditionalMaterial,
    Course,
    CourseSeries,
    Format,
...
def seed_table_one(
    ...
    **kwargs,
    ...
    df_to_seed.to_sql(name=table_name, con=connection, if_exists=if_exists, **kwargs)
